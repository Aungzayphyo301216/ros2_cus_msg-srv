...
bool motor_msg__srv__add_two_int__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_msg.srv._add_two_int.AddTwoInt_Request", full_classname_dest, 44) == 0);
  }
  motor_msg__srv__AddTwoInt_Request * ros_message = _ros_message;
  {  // a
...
PyObject * motor_msg__srv__add_two_int__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_msg.srv._add_two_int");
...
ROSIDL_GENERATOR_C_EXPORT
bool motor_msg__srv__add_two_int__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_msg.srv._add_two_int.AddTwoInt_Response", full_classname_dest, 45) == 0);
  }
  motor_msg__srv__AddTwoInt_Response * ros_message = _ros_message;
  {  // sum
