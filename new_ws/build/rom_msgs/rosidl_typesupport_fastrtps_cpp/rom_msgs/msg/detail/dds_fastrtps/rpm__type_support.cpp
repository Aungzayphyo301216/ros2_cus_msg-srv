...
#include "rom_msgs/msg/detail/rpm__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rom_msgs::msg::Rpm *>(
    untyped_ros_message);
...
{
  return &rom_msgs::msg::typesupport_fastrtps_cpp::_Rpm__handle;
}
