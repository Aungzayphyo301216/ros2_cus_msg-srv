...
static const _AddTwoInt_Request_type_support_symbol_names_t _AddTwoInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_msg, srv, AddTwoInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_msg, srv, AddTwoInt_Request)),
  }
};
...
{
  return &::motor_msg::srv::rosidl_typesupport_cpp::AddTwoInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_msg, srv, AddTwoInt_Request)() {
  return get_message_type_support_handle<motor_msg::srv::AddTwoInt_Request>();
}
...
static const _AddTwoInt_Response_type_support_symbol_names_t _AddTwoInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_msg, srv, AddTwoInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_msg, srv, AddTwoInt_Response)),
  }
};
...
{
  return &::motor_msg::srv::rosidl_typesupport_cpp::AddTwoInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_msg, srv, AddTwoInt_Response)() {
  return get_message_type_support_handle<motor_msg::srv::AddTwoInt_Response>();
}
...
static const _AddTwoInt_type_support_symbol_names_t _AddTwoInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_msg, srv, AddTwoInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_msg, srv, AddTwoInt)),
  }
};
...
{
  return &::motor_msg::srv::rosidl_typesupport_cpp::AddTwoInt_service_type_support_handle;
}
