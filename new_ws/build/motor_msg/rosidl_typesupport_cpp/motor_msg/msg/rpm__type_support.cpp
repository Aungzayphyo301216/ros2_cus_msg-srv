...
static const _Rpm_type_support_symbol_names_t _Rpm_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_msg, msg, Rpm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_msg, msg, Rpm)),
  }
};
...
{
  return &::motor_msg::msg::rosidl_typesupport_cpp::Rpm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_msg, msg, Rpm)() {
  return get_message_type_support_handle<motor_msg::msg::Rpm>();
}
