...
#ifndef MOTOR_MSG__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
#define MOTOR_MSG__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
 ...
 * calls
 * motor_msg__srv__AddTwoInt_Request__init().
...
/**
 * It calls
 * motor_msg__srv__AddTwoInt_Request__fini()
 ...
 * motor_msg__srv__AddTwoInt_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * motor_msg__srv__AddTwoInt_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * motor_msg__srv__AddTwoInt_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motor_msg
...
/**
 * It calls
 * motor_msg__srv__AddTwoInt_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_motor_msg
...
/**
 * It allocates the memory for the array and calls
 * motor_msg__srv__AddTwoInt_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_motor_msg
...
/**
 * It calls
 * motor_msg__srv__AddTwoInt_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOTOR_MSG__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
