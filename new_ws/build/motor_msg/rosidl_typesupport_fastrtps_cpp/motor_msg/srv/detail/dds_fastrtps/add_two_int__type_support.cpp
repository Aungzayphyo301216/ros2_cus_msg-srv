...
#include "motor_msg/srv/detail/add_two_int__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const motor_msg::srv::AddTwoInt_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_msg::srv::AddTwoInt_Request *>(
    untyped_ros_message);
...
{
  return &motor_msg::srv::typesupport_fastrtps_cpp::_AddTwoInt_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const motor_msg::srv::AddTwoInt_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<motor_msg::srv::AddTwoInt_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &motor_msg::srv::typesupport_fastrtps_cpp::_AddTwoInt_Response__handle;
}
...
{
  return &motor_msg::srv::typesupport_fastrtps_cpp::_AddTwoInt__handle;
}
