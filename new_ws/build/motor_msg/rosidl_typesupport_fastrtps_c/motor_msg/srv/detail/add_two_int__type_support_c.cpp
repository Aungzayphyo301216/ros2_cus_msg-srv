...
#include "motor_msg/srv/detail/add_two_int__rosidl_typesupport_fastrtps_c.h"
...
using _AddTwoInt_Request__ros_msg_type = motor_msg__srv__AddTwoInt_Request;
...
size_t get_serialized_size_motor_msg__srv__AddTwoInt_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddTwoInt_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_msg__srv__AddTwoInt_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_msg
size_t max_serialized_size_motor_msg__srv__AddTwoInt_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInt_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motor_msg__srv__AddTwoInt_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_msg, srv, AddTwoInt_Request)() {
...
using _AddTwoInt_Response__ros_msg_type = motor_msg__srv__AddTwoInt_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_msg
size_t get_serialized_size_motor_msg__srv__AddTwoInt_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddTwoInt_Response__ros_msg_type * ros_message = static_cast<const _AddTwoInt_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_msg__srv__AddTwoInt_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_msg
size_t max_serialized_size_motor_msg__srv__AddTwoInt_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _AddTwoInt_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motor_msg__srv__AddTwoInt_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_msg, srv, AddTwoInt_Response)() {
...
// already included above
// #include "motor_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "motor_msg/srv/add_two_int.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_msg, srv, AddTwoInt)() {
